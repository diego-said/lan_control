VERSION 5.00
Begin VB.Form FRMvisualfunc 
   BackColor       =   &H00000000&
   BorderStyle     =   4  'Fixed ToolWindow
   Caption         =   "Selecione o funcionário para alteração\exclusão"
   ClientHeight    =   4470
   ClientLeft      =   45
   ClientTop       =   285
   ClientWidth     =   6000
   ...
   MDIChild        =   -1  'True
   MinButton       =   0   'False
   Picture         =   "FRMvisualfunc.frx":0000
   ScaleHeight     =   4470
   ScaleWidth      =   6000
   ...
   End
End
Attribute VB_Name = "FRMvisualfunc"
...
Set dados = banco.OpenRecordset("funcionarios", dbOpenTable)
Do While dados.EOF = False
If LSTlistafunc.Text = dados.Fields("nome") Then
dados.Delete
...
Do While dados.EOF = False
If LSTlistafunc.Text = dados.Fields("nome") Then
codfuncionario = dados.Fields("codigo")
End If
dados.MoveNext
Loop
FRMalterafunc.Show
